...
async function mintNFT(tokenURI) {
    const nonce = await web3Instance.eth.getTransactionCount(PUBLIC_KEY, 'latest'); //get latest nonce
  ...
  //the transaction
    ...
    const signPromise = web3Instance.eth.accounts.signTransaction(tx, PRIVATE_KEY)
    signPromise
      .then((signedTx) => {
